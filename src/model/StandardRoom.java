...
public class StandardRoom extends Room {
	...
	public StandardRoom(String roomId, int numberOfBeds, String roomType,String roomStatus, String summary, String roomImage) {
	...
	public String toString() {
		...
		toString = super.getRoomId() + ":" + super.getNumberOfBeds() + ":" + super.getRoomType() + ":" +
				super.getRoomStatus() + ":" + super.getFeatures() +":"+ super.getRoomImage() ;
